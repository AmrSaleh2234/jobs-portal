                            ...
                            <div class="tab-content">
                                <div id="candidate"
                                    ...
                                    <div class="socialLogin">
                                        ...
                                        <a href="{{ url('login/jobseeker/google')}}" style="border: 2px solid;background-color: #ccccd2;width: 40px;height: 40px ">
                                            <i class="fab fa-google" aria-hidden="true" style="color: red"></i>
                                        </a>
                                    </div>
                                ...
                                <div id="employer"
                                    ...
                                    <!-- sign up form -->
                                    <div class="newuser"><i class="fas fa-user"
                                                            aria-hidden="true"></i> {{__('New User')}}? <a
                                                href="{{route('register')}}">{{__('Register Here')}}</a></div>

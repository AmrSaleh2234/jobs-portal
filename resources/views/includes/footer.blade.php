...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('All Rights Reserved')}}. {{__('Design by')}}: <a href="https://visualinnovate.com" target="_blank" style="color:#58408D">Visual Innovate </a></div>
            </div>
            <div class="col-md-4">
